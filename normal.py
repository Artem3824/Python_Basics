...
numbers = [1, 2, 7, 0, -5, 8, 9, -25, 25, 4, 36]
new_list = []
for number in numbers:
    if number > 0 and (len(str(number ** 0.5)) == 3):
...
numbers = [1, 2, 4, 5, 6, 2, 5, 2, 12, 1, 13, 25, 13]
original = set(numbers)
print('Исходный список: ', numbers)
print('Список неповторяющихся значений: ', list(original))
unique = []
for number in numbers:
    if numbers.count(number) == 1:
        unique.append(number)
print('Список уникальных значений: ', unique)
